...
use crate::types::{AsTypeRef, BasicType, FunctionType, StructType, BasicTypeEnum};
...
impl<'ctx> Module<'ctx> {
    ...
    /// get intrinsic
    pub unsafe fn get_intrinsic(&self, name: &str, param_types: &[BasicTypeEnum<'ctx>]) -> Option<FunctionValue<'ctx>> {
